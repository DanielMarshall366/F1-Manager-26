...
<body>
  ...
  <p>You will need to manage your engine's temperature. Engines heat up due to high fuel aggression and driving in the dirty of a car within 2 seconds ahead. Overheating the engine can lead to faults<img src="Icons/Minor Fault.png" alt="Fault" width="30">   or even an engine failure that will end that driver's race.</p>
